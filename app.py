...
st.markdown("""
    ...
    /* صناديق ومربعات التأصيل العلمي المتراصة العريضة مع تأمين الفونت الداخلي كاملاً */
    .science-box {
    ...
    /* 🛠️ هندسة الشريط العلوي الداكن بداخل الكروت ليقعد العنوان جواه بالظبط وفي سطر واحد */
    .card-top-header {
    ...
    .card-top-header h3 {
        ...
        white-space: nowrap !important; /* إجبار العنوان على الظهور في سطر واحد بدون النزول لسطر جديد */
    ...
    /* سنترة وجدولة البيانات التغذوية الرسمية كاملاً بداخل المربعات */
    .stTable table {
        background-color: #14141c !important;
        border-radius: 12px !important;
        overflow: hidden !important;
...
الموسوعة العلمية والتغذوية الخاصة بك (يجب أن تجيب منها بدقة وثقة):
...
- إذا سألك المستخدم "بكام؟"، "السعر كام؟"، أو عن التكلفة، يجب أن تكون إجابتك دبلوماسية وذكية بيعياً كالآتي:
...
# ==========================================
# التبويب الأول: الكتالوج المقسم بالتساوي وبدون مربعات فارغة
# ==========================================
with tab1:
    st.write("")
...
# ==========================================
# التبويب الثالث: الشات الذكي والأتمتة
# ==========================================
with tab3:
    st.markdown("### 💬 SheroBot - مستشارك الذكي")
    if st.button("🗑️ مسح سجل المحادثة بالكامل", key="clear_chat_button"):
...
# ==========================================
# التبويب الرابع: استمارة الشحن والطلب السريع مع الخريطة
# ==========================================
with tab4:
