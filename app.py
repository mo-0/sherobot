...
st.markdown("""
    ...
    /* 🛠️ الحل الجذري: إجبار خط Cairo والسنترة على جميع المستويات والمكونات الداخلية */
    ...
    /* فرض خط Cairo على مكونات الأزرار بشكل مباشر */
    ...
    /* تنسيق التبويبات العلوية (Tabs) ودفعها لأسفل قليلاً لراحة العين */
    ...
    /* صناديق ومربعات التأصيل العلمي المتراصة العريضة مع تأمين الفونت الداخلي */
    .science-box {
    ...
    /* إجبار أي نص داخل الـ science-box على إتباع الـ Cairo والسنترة */
    .science-box * {
        font-family: 'Cairo', sans-serif !important;
        text-align: center !important;
    }
    ...
    /* سنترة وجدولة البيانات التغذوية الرسمية */
    .stTable table {
        background-color: #14141c !important;
    ...
    .photo-placeholder {
        background: #1b1b26; border: 1px dashed #f39c12; border-radius: 12px; padding: 30px; text-align: center; color: #aaa; font-size: 13px; max-width: 600px; margin: 15px auto;
    }
    </style>
...
قواعد الرد: رد بلهجة مصرية ودودة جداً وموزونة ومحاذاة سنتر، ولا تستخدم مصطلحات أو وسوم تسبب طلاسم لغوية. وجه العميل دائماً للتبويب الرابع لإتمام الشراء.
"""
...
# 3. الأبواب الأربعة للواجهة بأسماء جديدة وعصرية ونزول مريح للأسفل
...
# ==========================================
# التبويب الأول: الكتالوج والتجربة المودرن النظيفة
# ==========================================
with tab1:
    st.write("")
    ...
    try:
        ...
        st.markdown("<div class='photo-placeholder'>💡 [يرجى التأكد من رفع ملف باسم mango_pack.png]</div>", unsafe_allow_html=True)
    ...
    try:
        ...
        st.markdown("<div class='photo-placeholder'>💡 [يرجى التأكد من رفع ملف باسم strawberry_pack.png]</div>", unsafe_allow_html=True)
...
# ==========================================
# التبويب الثاني: التأصيل العلمي والاستدامة (Full Width - Cairo Fixed)
# ==========================================
with tab2:
    st.write("")
    ...
    try:
        ...
        st.markdown("<div class='photo-placeholder'>💡 [يرجى رفع ملف باسم team_photo.jpg لتظهر الصورة بالمنتصف]</div>", unsafe_allow_html=True)
...
# ==========================================
# التبويب الثالث: الشات الذكي مع الاستدعاء المحايد للأيقونات واللوجو
# ==========================================
with tab3:
    ...
    # استخدام استدعاء داخلي نظيف للأفاتار يمنع الرموز المكسورة
    for message in st.session_state.chat_history:
        avatar_source = "logo.png"
        try:
